module BedrockCaller
  ...
  def call_bedrock(prompt, system_prompt: nil, max_tokens: 1024, temperature: 0.3, model_id: nil)
    ...
    params = {
      model_id:         model_id.presence || ENV.fetch("BEDROCK_MODEL_ID", DEFAULT_MODEL),
